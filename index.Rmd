...
**.black[[Corrado Lanera](https://CorradoLanera.it)]** | [**.orange[Laboratory of Artificial Intelligence for Medical Sciences]**](https://www.unipd-ubep.it/topics-laboratories/artificial-intelligence-for-medical-sciences-laims/)<br>[**Unit of Biostatistics, Epidemiology, and Public Health**](https://www.unipd-ubep.it/) | [**.red[University of Padova]**](https://unipd.it)<br>[.black[Department of Cardiac, Thoracic, Vascular Sciences, and Public Health]](https://www.dctv.unipd.it/)
...
.left[
_If you think the only acceptable performance is the ".orange[perfect performance]",<br>AI is not for you! ...But, I've heard that even humans have made mistakes..._
]

.tr[
— Daniel Oberski<br>2021/03/26 ASReview interview - https://daob.nl/
]
]
...
# knitr::include_graphics("img/bit.ly_<qrcode>.png")
```
