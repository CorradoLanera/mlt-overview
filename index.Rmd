...
Purpose of this class is to introducing **.orange[what is]** Machine Learning, why/in what is different from other (statistical) tools, how to understand (and **.orange[trust]**!) it's results, and looking at **.orange[some example]** and **.orange[best practice]** in conducing a machine learning project. This from simple _classical_ techniques to large language models.

<br>
<br>

My principal aim is to let you able to start **.orange[understanding]** (and **.orange[evaluating]** the quality!) of a machine learning project when used for clinical purposes (possibly regardless of its complexity).
...
**.orange[Promise]: I do not show you any code `r emo::ji("halo")`**
...
Parts of the following slides and their contents were produced thanks to the precious work of .orange[**Paola Berchialla**] (UniTo/DSCB)
...
- **Intro**: what does it means "Machine Learning"?
...
- **Large** **.orange[Language Models]** (and ChatGPT)
...
<img src="img/ml-process.png" width="95%" />
]

.pull-right[
<img src="img/mlt_loop.png" width="85%" />
]
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align="center", out.width="100%", fig.alt="https://youtu.be/zxQyTK8quyY"}
knitr::include_graphics("img/attention.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.alt="https://openai.com/pricing"}
knitr::include_graphics(
...
---
# .orange[Playground] (GUI4API test `r emo::ji("sweat_smile")`)


```{r, echo=FALSE, out.width="100%", fig.alt="https://platform.openai.com/playground"}
knitr::include_graphics(
  here::here("img/playground.png")
)
```
...
```{r, echo=FALSE, out.width="100%", fig.alt="https://platform.openai.com/playground"}
knitr::include_graphics(
  here::here("img/playground-cost.png")
)
```
