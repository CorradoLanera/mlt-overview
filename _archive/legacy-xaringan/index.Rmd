...
date: "2025-09-23 (last update: `r Sys.Date()`)"
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align="center", out.width="90%"}
knitr::include_graphics("img/imagetypegrayscale.png")
```

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align="center", out.width="90%"}
knitr::include_graphics("img/imagetypergb.png")
```
...
<br>
```{r, echo=FALSE}
knitr::include_graphics("img/900M-uers.png")
```
